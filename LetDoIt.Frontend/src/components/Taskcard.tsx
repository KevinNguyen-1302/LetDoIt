  ...
  return (
    <>
      <div
        ...
        className={`rounded-xl p-3 mb-3 border-2 ${isOverlay ? "cursor-grabbing" : "cursor-grab"
      ...
      >
        ...
        {task.description && (
          <p className={`text-xs text-gray-700 line-clamp-2 mb-2 ${task.isCompleted ? "opacity-50" : ""}`}>
            {task.description}
          </p>
        )}
