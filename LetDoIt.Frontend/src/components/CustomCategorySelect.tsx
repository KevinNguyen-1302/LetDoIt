...
import { getMyCategories, type CategoryResponse } from '../services/taskService';
...
const CustomCategorySelect = ({ value, onChange }: CustomCategorySelectProps) => {
    ...
    return (
        <div className="relative w-full font-bold" ref={dropdownRef}>
            ...
            <button
                ...
                className={clsx(
                    "w-full px-4 py-3 rounded-[10px] border-2 border-black bg-white text-left text-black flex justify-between items-center transition-all duration-150 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none",
            ...
            >
                ...
                <ChevronDown size={20} className={clsx("transition-transform duration-200", isOpen && "rotate-180")} />
            </button>
            ...
            {isOpen && (
                <ul className="absolute z-50 w-full mt-2 bg-white border-2 border-black rounded-[10px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] max-h-40 overflow-y-auto overflow-x-hidden p-1 space-y-1">
                    ...
                    <li
                        ...
                        className="px-4 py-2 rounded-[6px] text-gray-400 hover:bg-[#f0f0f0] hover:text-black cursor-pointer transition-colors duration-150 font-medium"
                    >
                        Select Category
                    </li>
                    ...
                    {categories.map(cat => (
                        <li
                            ...
                            className={clsx(
                                "px-4 py-2 rounded-[6px] cursor-pointer transition-colors duration-150 text-black",
                    ...
                    <li
                        ...
                        className="px-2 py-2 flex justify-center items-center gap-2 rounded-[6px] bg-[#E8FF46]/30 text-emerald-700 hover:bg-[#E8FF46] border border-dashed border-emerald-500 cursor-pointer font-bold transition-all duration-150"
                    >
